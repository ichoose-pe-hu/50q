...
#answer span:first-child:before {
  content:"I would definitely love them";
}
#answer span:first-child label:after {
  content:"絶対に好きになる";
}
#answer span:last-child:before {
  content:"I might not love them";
}
...
<div class="question">
<h2>Do you think you would love things that you love now if you reborn?</h2>
<p>自分が好きなものを生まれ変わっても好きになる？</p>
