...
#answer span:first-child:before {
  content:"because of this project";
}
#answer span:first-child label:after {
  content:"例1)このプロジェクトがあったから。";
}
#answer span:last-child:before {
  content:"it is god only knows";
}
#answer span:last-child label:after {
  content:"例2)それは、神のみぞが知るコトさ。";
}
#enquete span {
...
<div class="question">
<h2>Why are you and I are asking questions like this?</h2>
<p>なぜ、あなたと私は、今、こうして、質問し合っているのでしょうか？</p>
